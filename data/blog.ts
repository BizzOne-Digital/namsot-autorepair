...
export const blogPosts: BlogPost[] = [
  {
    ...
    readTime: "5 min read",
    imageUrl: unsplash("photo-1677230017881-a7bd1fb08d36"),
    imageAlt: "Technician working on an engine bay during an oil service",
    content: [
      ...
      "Watch for warning signs: dark, gritty oil on the dipstick, increased engine noise, or the oil change reminder on your dashboard. At Namsot Auto Repairs, we use quality oils matched to your vehicle and inspect related components during every oil service.",
    ],
  },
  {
    ...
    category: "Safety",
    readTime: "4 min read",
    imageUrl: unsplash("photo-1760317890322-364a810cd4da"),
    imageAlt: "Close-up of a vehicle brake disc and caliper",
    content: [
  ...
  },
  {
    ...
    category: "Seasonal",
    readTime: "6 min read",
    imageUrl: unsplash("photo-1579385509017-a5864e8c7c4d"),
    imageAlt: "Car driving along a snow-covered road during a snowfall",
    content: [
      ...
      "Pack an emergency kit: flashlight, jumper cables, ice scraper, blanket, and phone charger. Schedule a pre-winter inspection at Namsot Auto Repairs — we'll check everything from wipers to heating systems so you're ready for the season ahead.",
    ],
  },
  {
    ...
    category: "Maintenance",
    readTime: "5 min read",
    imageUrl: unsplash("photo-1727582921142-c1ec394c2ced"),
    imageAlt: "Close-up of a vehicle tire and alloy wheel",
    content: [
      ...
      "Replace tires when tread depth reaches 4/32 inches on wet roads or 2/32 inches legally. Look for cracks, bulges, or punctures in the sidewall. At Namsot Auto Repairs, we inspect tires during every service and help you maximize safety and value.",
    ],
  },
];
